...
ROS source dependencies are vendored. The initial Docker build still needs
network access for the base image and system/ROS packages. Use the repository-root
README for current Jalpari submission instructions; this file is background documentation.
